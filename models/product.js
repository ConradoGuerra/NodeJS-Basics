...
const productSchema = new Schema({
  //Schema is a JS object with fields, in the field we have the type we want and if its required to fill or not
  title: {
    type: String,
    required: true
  },
...
//Exporting our created schema to a model, a model connect the schema to a name, in this case, "Product"
